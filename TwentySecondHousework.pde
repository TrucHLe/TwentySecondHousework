...
PFont beginFont, meterFont;

PImage Background, simplekitchen, baby, housewife, banana;

int begin;               // Time the event/game begins
boolean active, lose, win, burnt;

float StoveMeterBar;
float xHouseWife, yHouseWife, xHouseWifeSpeed, yHouseWifeSpeed;
float BabyMeterBar, xBaby, yBaby, xBabySpeed, yBabySpeed;
float BananaMeterBar, xBanana, yBanana;
